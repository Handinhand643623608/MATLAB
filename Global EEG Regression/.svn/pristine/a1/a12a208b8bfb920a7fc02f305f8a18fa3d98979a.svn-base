...
paramStruct.xcorr.globSig_BOLD = struct(...
    ...
    'visibleFigs', 'off',...
    'shiftsTime', [-20:2:20],...
    'shiftsToImage', [-20:4:20],...
    'slicesToImage', [48:2:64],...
    'alphaVal', 0.05,...
    'parallelPVals', false,...
    'parallelSwitch', false,...
    'imageSingleSubjects', false,...
    'comments', 'For publication: DC EEG Global Signal to BOLD correlations (Alpha = 0.05)');
...
fileStruct.analysis.xcorr.globSig_BOLD = struct(...
    ...
    'savePathImage', [fileStruct.paths.analyses '\Global Regression\Global-BOLD\Five Pct Alpha\Montage'],...
    'saveID', '20130117');
...
% ai_corrEEG(fileStruct, paramStruct);
