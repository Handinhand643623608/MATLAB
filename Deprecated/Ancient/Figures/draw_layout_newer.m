function [x,y,h] = draw_layout_newer(adj,labels,node_t,x,y,type,arrow_size)
...
% Modified by Josh Grooms November 16, 2011
%
% Requires: BSMART
%
...
if ~isempty(idx1),
    [h1 wd1] = textoval_new(x(idx1), y(idx1), labels(idx1));
    set(h1,'LineStyle',':');
end;
...
if ~isempty(idx2),
    ...
    [h2 wd2] = textoval_new(x(idx2), y(idx2), labels(idx2));
end;
