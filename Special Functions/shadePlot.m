...
%       20140414:   Implemented the ability to plot to pre-existing axes. In this case, none of the
%                   axes font, color, label, or line weight input settings are used.
