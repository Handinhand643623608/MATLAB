...
%   OUTPUT:
%		p:				STRING
%						A path string pointing to the folder where the inputted file exists on the hard drive. If the file name
%						being searched for does not exist or is not in a directory that is included in MATLAB's working path
%						list, then this will be an empty string. Otherwise, it will be the full path to the folder without
%						the file name or extension included at the end.
%
%   INPUT:
%		fileName:       STRING
